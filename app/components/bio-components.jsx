            ...
            <div className="space-y-6">
                {data.education.map((edu, index) => (
                    ...
                    >
                        ...
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 text-zinc-700 dark:text-zinc-300">
                            <p className="text-lg font-medium">
                                {edu.institution} - <span className="text-base text-zinc-600 dark:text-zinc-400">{edu.location}</span>
                            </p>
                            <span className="text-sm font-semibold text-zinc-600 dark:text-zinc-400 mt-1 md:mt-0">
                                {edu.grade}
                            </span>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {edu.relevant_courses.map((course) => (
                                        <span
                                            key={course}
                                            className="px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 text-xs rounded-md border border-green-200 dark:border-green-800"
                                        >
                                            {course}
                                        </span>
                                    ))}
