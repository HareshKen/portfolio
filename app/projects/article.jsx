    ...
    return (
        <article className="p-4 md:p-8">
            ...
            <Link href={appLink} target="_blank" rel="noopener noreferrer">
                <h2 className="z-20 text-xl font-medium lg:text-3xl text-zinc-200 group-hover:text-white font-display cursor-pointer" title={`Click to view the ${project.homepage ? 'app' : 'repo'}.`}>
